...
if (!html.includes("generator.html") || !generator.includes("report-json") || !generator.includes("evidence-files") || !generator.includes('id="sample-data"') || !generatorApp.includes("facadefixer-generated-report") || !preview.includes("app.js") || !app.includes("report-data.example.json")) throw new Error("entry point is incomplete");
